      ...
      <main className="flex-1 px-6 sm:px-8 py-8 sm:py-10 w-full max-w-7xl mx-auto space-y-8">
        ...
        {activeTab === "riwayat" && (
          <div className="p-8 bg-white rounded-xl outline outline-1 outline-[#C3C6D7] shadow-xs text-center text-slate-600">
            ...
            <p className="text-sm text-[#434655] mt-2">Menampilkan riwayat lengkap skrining anemia untuk Siti Aminah (ID-9921).</p>
          </div>
        )}
        ...
        {activeTab === "tindak-lanjut" && (
          <div className="p-8 bg-white rounded-xl outline outline-1 outline-[#C3C6D7] shadow-xs text-center text-slate-600">
            ...
            <p className="text-sm text-[#434655] mt-2">Daftar rekomendasi intervensi medis dan jadwal kontrol ulang.</p>
          </div>
        )}
        ...
        {activeTab === "laporan" && (
          <div className="p-8 bg-white rounded-xl outline outline-1 outline-[#C3C6D7] shadow-xs text-center text-slate-600">
            ...
            <p className="text-sm text-[#434655] mt-2">Unduh atau cetak laporan diagnostik lengkap HemaVision Pro.</p>
          </div>
        )}
      </main>
    </div>
